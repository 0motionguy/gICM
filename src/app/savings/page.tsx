...
import { Sparkles, TrendingDown, Zap, DollarSign, Clock, Check, ArrowLeft } from "lucide-react";
      ...
      <main className="max-w-7xl mx-auto px-6 md:px-10 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl md:text-6xl font-display font-bold text-white mb-6 tracking-tight">
            Stop Paying for{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-orange-400 line-through decoration-white/30">Wasted Tokens</span>
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto mb-16">
            <GlassCard className="p-8 text-center group hover:border-[#00F0FF]/30 transition-colors">
              ...
              <h3 className="font-bold text-white text-lg mb-2">88-92% Less Tokens</h3>
            ...
            <GlassCard className="p-8 text-center group hover:border-[#7000FF]/30 transition-colors">
              ...
              <h3 className="font-bold text-white text-lg mb-2">Massive Cost Savings</h3>
              <p className="text-sm text-zinc-400">
            ...
            <GlassCard className="p-8 text-center group hover:border-[#10A37F]/30 transition-colors">
              ...
              <h3 className="font-bold text-white text-lg mb-2">Faster Responses</h3>
              <p className="text-sm text-zinc-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <GlassCard className="p-8 relative overflow-hidden">
              ...
              <div className="flex items-center gap-4 mb-6 relative z-10">
                ...
                <div>
                  <h3 className="font-bold text-white text-xl">Solo Developer</h3>
                  <p className="text-sm text-zinc-400">Building a SaaS product</p>
                </div>
              </div>

              <div className="space-y-4 mb-6 relative z-10">
                <div className="flex items-center gap-3 text-sm">
                  <div className="h-5 w-5 rounded-full bg-blue-500/20 flex items-center justify-center"><Check className="w-3 h-3 text-blue-400" /></div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-5 relative z-10">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-3xl font-black text-blue-400">$1,044</span>
                </div>
              </div>
            </GlassCard>
            ...
            <GlassCard className="p-8 relative overflow-hidden">
              ...
              <div className="flex items-center gap-4 mb-6 relative z-10">
                ...
                <div>
                  <h3 className="font-bold text-white text-xl">5-Person Team</h3>
              ...
              <div className="space-y-4 mb-6 relative z-10">
                <div className="flex items-center gap-3 text-sm">
                  <div className="h-5 w-5 rounded-full bg-[#7000FF]/20 flex items-center justify-center"><Check className="w-3 h-3 text-[#A060FF]" /></div>
                  <span className="text-zinc-300">25 skill uses per day (total)</span>
                </div>
                <div className="flex items-center gap-3 text-sm">
                  <div className="h-5 w-5 rounded-full bg-[#7000FF]/20 flex items-center justify-center"><Check className="w-3 h-3 text-[#A060FF]" /></div>
              ...
              <div className="bg-[#7000FF]/10 border border-[#7000FF]/20 rounded-xl p-5 relative z-10">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm text-zinc-400">Monthly Savings</span>
                  <span className="text-2xl font-black text-[#A060FF]">$478</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-zinc-400">Yearly Savings</span>
                  <span className="text-3xl font-black text-[#A060FF]">$5,736</span>
                </div>
              </div>
            </GlassCard>
            ...
            <GlassCard className="p-8 relative overflow-hidden">
              ...
              <div className="flex items-center gap-4 mb-6 relative z-10">
                ...
                <div>
                  <h3 className="font-bold text-white text-xl">20-Person Agency</h3>
                  <p className="text-sm text-zinc-400">Full-service development</p>
                </div>
              </div>

              <div className="space-y-4 mb-6 relative z-10">
                <div className="flex items-center gap-3 text-sm">
                  <div className="h-5 w-5 rounded-full bg-orange-500/20 flex items-center justify-center"><Check className="w-3 h-3 text-orange-400" /></div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/20 rounded-xl p-5 relative z-10">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm text-zinc-400">Monthly Savings</span>
                  <span className="text-2xl font-black text-orange-400">$2,340</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-zinc-400">Yearly Savings</span>
                  <span className="text-3xl font-black text-orange-400">$28,080</span>
                </div>
              </div>
            </GlassCard>
            ...
            <GlassCard className="p-8 relative overflow-hidden">
              ...
              <div className="flex items-center gap-4 mb-6 relative z-10">
                ...
                <div>
                  <h3 className="font-bold text-white text-xl">Enterprise Team</h3>
              ...
              <div className="space-y-4 mb-6 relative z-10">
                <div className="flex items-center gap-3 text-sm">
                  <div className="h-5 w-5 rounded-full bg-[#00F0FF]/20 flex items-center justify-center"><Check className="w-3 h-3 text-[#00F0FF]" /></div>
                  <span className="text-zinc-300">500+ skill uses per day</span>
                </div>
                <div className="flex items-center gap-3 text-sm">
                  <div className="h-5 w-5 rounded-full bg-[#00F0FF]/20 flex items-center justify-center"><Check className="w-3 h-3 text-[#00F0FF]" /></div>
                  <span className="text-zinc-300">Opus for complex workflows</span>
                </div>
              </div>
              ...
              <div className="bg-[#00F0FF]/10 border border-[#00F0FF]/20 rounded-xl p-5 relative z-10">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm text-zinc-400">Monthly Savings</span>
                  <span className="text-2xl font-black text-[#00F0FF]">$14,200</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-zinc-400">Yearly Savings</span>
                  <span className="text-3xl font-black text-[#00F0FF]">$170,400</span>
                </div>
              </div>
            </GlassCard>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  <Badge variant="destructive" className="text-sm px-3 py-1">Traditional</Badge>
                </div>
              ...
              <div>
                <div className="flex items-center gap-3 mb-4">
                  <Badge className="text-sm px-3 py-1 bg-[#00F0FF] text-black hover:bg-[#00F0FF]/90">Progressive</Badge>
                </div>
                <p className="text-sm text-zinc-400 mb-6 leading-relaxed">
            ...
            <div className="mt-10 pt-8 border-t border-white/10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                <div className="bg-[#00F0FF]/10 border border-[#00F0FF]/20 rounded-xl p-4">
                  ...
                  <p className="text-xs text-zinc-400 uppercase tracking-wider mt-1">Token Reduction</p>
                </div>
                <div className="bg-[#7000FF]/10 border border-[#7000FF]/20 rounded-xl p-4">
                  <p className="text-3xl font-black text-[#A060FF]">4.7x</p>
                  <p className="text-xs text-zinc-400 uppercase tracking-wider mt-1">Faster Builds</p>
                </div>
                <div className="bg-white/5 border border-white/10 rounded-xl p-4">
                  <p className="text-3xl font-black text-white">100%</p>
                  <p className="text-xs text-zinc-400 uppercase tracking-wider mt-1">Quality Output</p>
                </div>
              </div>
            </div>
          </GlassCard>
