...
export const WORKFLOWS: RegistryItem[] = [
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/solana-defi-protocol-launch",
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/nft-marketplace-deploy",
    orchestrationPattern: "sequential",
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/web3-saas-api-launch",
    orchestrationPattern: "sequential",
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/solana-token-launch",
    orchestrationPattern: "sequential",
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/security-audit-pipeline",
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/deploy-with-tests",
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/full-stack-feature-builder",
    orchestrationPattern: "sequential",
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/tdd-workflow",
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/full-stack-solana-feature",
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/security-complete-audit",
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/test-pyramid-build",
    orchestrationPattern: "hybrid", // Parallel → Sequential
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/staged-deployment-pipeline",
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/evm-dapp-complete",
    orchestrationPattern: "hybrid", // Sequential → Parallel → Sequential → Sequential
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/defi-protocol-integration",
    orchestrationPattern: "hybrid", // Sequential → Parallel → Sequential → Sequential
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/performance-optimization-suite",
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/incident-response-protocol",
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/api-documentation-complete",
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/monitoring-observability-setup",
    orchestrationPattern: "hybrid", // Parallel → Sequential
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/qa-release-validation",
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/economic-security-analysis",
    orchestrationPattern: "hybrid", // Parallel → Sequential
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/penetration-test-web3",
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/onboarding-quickstart-generator",
    orchestrationPattern: "sequential",
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/changelog-release-notes",
    orchestrationPattern: "sequential",
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/microservices-architecture-setup",
    orchestrationPattern: "hybrid", // Sequential → Parallel → Sequential
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/graphql-api-complete",
    orchestrationPattern: "sequential",
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/database-migration-safe",
    orchestrationPattern: "hybrid", // Sequential → Parallel → Sequential
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/mobile-app-mvp-launch",
    orchestrationPattern: "hybrid", // Sequential → Parallel → Sequential
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/pwa-progressive-enhancement",
    orchestrationPattern: "sequential",
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/ci-cd-pipeline-complete",
    orchestrationPattern: "hybrid", // Sequential → Parallel → Sequential
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/docker-containerization-workflow",
    orchestrationPattern: "sequential",
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/monorepo-workspace-setup",
    orchestrationPattern: "sequential",
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/legacy-code-refactor-safe",
    orchestrationPattern: "hybrid", // Sequential → Parallel → Sequential
...

  {
    ...
    install: "npx @clawdbot/cli add workflow/code-quality-baseline-setup",
  ...
  },
  {
    ...
    install: "npx @clawdbot/cli add workflow/full-icm-research",
    orchestrationPattern: "sequential",
  ...
  },
  {
    ...
    install: "npx @clawdbot/cli add workflow/launch-monitoring",
  ...
  },
  {
    ...
    install: "npx @clawdbot/cli add workflow/rug-protection",
    orchestrationPattern: "sequential",
  ...
  },
  {
    ...
    install: "npx @clawdbot/cli add workflow/smart-entry-exit",
    orchestrationPattern: "sequential",
