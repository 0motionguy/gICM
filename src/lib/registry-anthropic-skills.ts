...
export const ANTHROPIC_SKILLS: RegistryItem[] = [
  // === DOCUMENT SKILLS (5) ===
  {
    ...
    install: "npx @gicm/cli add skill/anthropic-docx",
    tokenSavings: 85,
    installs: 2341,
    remixes: 456,
    platforms: ["claude"],
  ...
  },
  {
    ...
    install: "npx @gicm/cli add skill/anthropic-pdf",
    tokenSavings: 87,
    installs: 3124,
    remixes: 678,
    platforms: ["claude"],
  ...
  },
  {
    ...
    install: "npx @gicm/cli add skill/anthropic-pptx",
    tokenSavings: 86,
    installs: 1987,
    remixes: 412,
    platforms: ["claude"],
  ...
  },
  {
    ...
    install: "npx @gicm/cli add skill/anthropic-xlsx",
    tokenSavings: 84,
    installs: 2756,
    remixes: 534,
    platforms: ["claude"],
  ...
  },
  {
    ...
    install: "npx @gicm/cli add skill/anthropic-doc-coauthoring",
    tokenSavings: 82,
    installs: 1654,
    remixes: 289,
    platforms: ["claude"],
  ...
  // === CREATIVE SKILLS (5) ===
  {
    ...
    install: "npx @gicm/cli add skill/anthropic-algorithmic-art",
    tokenSavings: 88,
    installs: 1432,
    remixes: 567,
    platforms: ["claude"],
  ...
  },
  {
    ...
    install: "npx @gicm/cli add skill/anthropic-canvas-design",
    tokenSavings: 85,
    installs: 1198,
    remixes: 345,
    platforms: ["claude"],
  ...
  },
  {
    ...
    install: "npx @gicm/cli add skill/anthropic-frontend-design",
    tokenSavings: 86,
    installs: 2876,
    remixes: 712,
    platforms: ["claude"],
  ...
  },
  {
    ...
    install: "npx @gicm/cli add skill/anthropic-theme-factory",
    tokenSavings: 83,
    installs: 1567,
    remixes: 423,
    platforms: ["claude"],
  ...
  },
  {
    ...
    install: "npx @gicm/cli add skill/anthropic-slack-gif-creator",
    tokenSavings: 81,
    installs: 987,
    remixes: 234,
    platforms: ["claude"],
  ...
  // === DEVELOPMENT SKILLS (3) ===
  {
    ...
    install: "npx @gicm/cli add skill/anthropic-mcp-builder",
    tokenSavings: 89,
    installs: 3456,
    remixes: 892,
    platforms: ["claude"],
  ...
  },
  {
    ...
    install: "npx @gicm/cli add skill/anthropic-web-artifacts-builder",
    tokenSavings: 84,
    installs: 2234,
    remixes: 567,
    platforms: ["claude"],
  ...
  },
  {
    ...
    install: "npx @gicm/cli add skill/anthropic-webapp-testing",
    tokenSavings: 86,
    installs: 1876,
    remixes: 412,
    platforms: ["claude"],
  ...
  // === ENTERPRISE SKILLS (2) ===
  {
    ...
    install: "npx @gicm/cli add skill/anthropic-brand-guidelines",
    tokenSavings: 82,
    installs: 1234,
    remixes: 289,
    platforms: ["claude"],
  ...
  },
  {
    ...
    install: "npx @gicm/cli add skill/anthropic-internal-comms",
    tokenSavings: 80,
    installs: 1098,
    remixes: 234,
    platforms: ["claude"],
  ...
  // === META SKILLS (1) ===
  {
    ...
    install: "npx @gicm/cli add skill/anthropic-skill-creator",
    tokenSavings: 90,
    installs: 4567,
    remixes: 1234,
    platforms: ["claude"],
