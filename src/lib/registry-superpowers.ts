...
- Supports parallel execution via dispatching-parallel-agents for test suites`,
    ...
    install: "npx @gicm/cli add skill/superpower-test-driven-development",
    tokenSavings: 94,
    installs: 2341,
    remixes: 876,
...
- Skipping verification phase`,
    ...
    install: "npx @gicm/cli add skill/superpower-systematic-debugging",
    tokenSavings: 91,
    installs: 1987,
    remixes: 712,
    platforms: ["claude", "gemini", "openai"],
...
Produces ranked options with pros/cons, leading to a recommended approach with clear rationale.`,
    ...
    install: "npx @gicm/cli add skill/superpower-brainstorming",
    tokenSavings: 89,
    installs: 1654,
    remixes: 598,
    platforms: ["claude", "gemini", "openai"],
...
- Supports parallel execution planning`,
    ...
    install: "npx @gicm/cli add skill/superpower-writing-plans",
    tokenSavings: 93,
    installs: 2156,
    remixes: 834,
    platforms: ["claude", "gemini", "openai"],
...
- Can dispatch to parallel-agents for independent tasks`,
    ...
    install: "npx @gicm/cli add skill/superpower-executing-plans",
    tokenSavings: 90,
    installs: 1876,
    remixes: 692,
    platforms: ["claude", "gemini", "openai"],
...
- Insufficient context leading to inconsistent results`,
    ...
    install: "npx @gicm/cli add skill/superpower-dispatching-parallel-agents",
    tokenSavings: 87,
    installs: 1423,
    remixes: 534,
    platforms: ["claude", "gemini", "openai"],
...
- Don't over-delegate simple tasks`,
    ...
    install: "npx @gicm/cli add skill/superpower-subagent-driven-development",
    tokenSavings: 92,
    installs: 1734,
    remixes: 645,
    platforms: ["claude", "gemini", "openai"],
...
\`\`\``,
    ...
    install: "npx @gicm/cli add skill/superpower-using-git-worktrees",
    tokenSavings: 88,
    installs: 1289,
    remixes: 478,
    platforms: ["claude", "gemini", "openai"],
