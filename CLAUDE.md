# OPUS 67 v6.0.0 "The Unification" - UNIFIED SYSTEM
...
- Activates 30 modes
- Injects THE DOOR
- Works IDENTICALLY every session
...
```bash
opus67              # Full boot (auto on session start)
...
- **session-start**: Logs session, sets environment
- **opus67-auto-detect**: Detects project type, pre-loads skills
- **pre-bash**: Validates before git push / npm publish
- **post-write**: Auto-formats TypeScript with Prettier
- **post-bash**: Tracks completions and wins
