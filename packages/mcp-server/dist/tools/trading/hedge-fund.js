...
// API HELPERS
// ============================================================================
async function fetchHedgeFund(endpoint, options) {
...
export async function getTradingStatus() {
    try {
        const status = await fetchHedgeFund("/api/status");
 ...
 */
export async function runAnalysis(token, mode = "full", chain = "solana") {
    try {
        const result = await fetchHedgeFund("/api/analyze", {
            method: "POST",
 ...
 * Set trading mode
 */
export async function setTradingMode(mode, approval_code) {
    try {
...
//# sourceMappingURL=hedge-fund.js.map