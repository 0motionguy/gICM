...
declare const HuntSourceSchema: z.ZodEnum<["github", "hackernews", "twitter", "reddit", "producthunt", "arxiv", "lobsters", "devto", "tiktok", "defillama", "geckoterminal", "feargreed", "binance", "polymarket", "kalshi", "fred", "sec", "finnhub", "npm"]>;
...
declare const HuntDiscoverySchema: z.ZodObject<{
    id: z.ZodString;
    source: z.ZodEnum<["github", "hackernews", "twitter", "reddit", "producthunt", "arxiv", "lobsters", "devto", "tiktok", "defillama", "geckoterminal", "feargreed", "binance", "polymarket", "kalshi", "fred", "sec", "finnhub", "npm"]>;
    sourceId: z.ZodString;
    sourceUrl: z.ZodString;
    title: z.ZodString;
    description: z.ZodOptional<z.ZodString>;
    ...
    id: string;
    source: "github" | "hackernews" | "twitter" | "reddit" | "producthunt" | "arxiv" | "lobsters" | "devto" | "tiktok" | "defillama" | "geckoterminal" | "feargreed" | "binance" | "polymarket" | "kalshi" | "fred" | "sec" | "finnhub" | "npm";
    discoveredAt: Date;
    tags: string[];
    relevanceFactors: {
        hasWeb3Keywords: boolean;
