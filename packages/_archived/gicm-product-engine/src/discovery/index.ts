...
import { UserFeedbackDiscovery } from "./sources/user-feedback.js";
...
export class DiscoveryManager {
  ...
  private userFeedback: UserFeedbackDiscovery;
   ...
   */
  addUserFeedback(
    feedback: Parameters<UserFeedbackDiscovery["addFeedback"]>[0]
  ): ReturnType<UserFeedbackDiscovery["addFeedback"]> {
    return this.userFeedback.addFeedback(feedback);
  }
}

export { OpportunityEvaluator } from "./evaluator.js";
export { UserFeedbackDiscovery } from "./sources/user-feedback.js";
export { CompetitorDiscovery } from "./sources/competitors.js";
export { GitHubDiscovery } from "./sources/github.js";
export { HackerNewsDiscovery } from "./sources/hackernews.js";
